...
def determine_category(product_name):
    ...
    pantry_keywords = ["בטעם עוף", "אורז", "מרק עוף", "בשמן", "גלטין", "פסטה", "קוסקוס", "טונה", "שימורים", "רסק", "רוטב", "סוכר", "חתיכות", "הרינג", "קמח", "מחית", "מצות", "שמן", "תבלין","מיץ לי","סודה לשתייה","חלב קוקוס", "פלפל שחור", "מלח", "קטניות", "עדשים", "שעועית", "פירורי לחם", "טחינה", "קפה", "תה"]
