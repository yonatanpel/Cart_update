...
def determine_category(product_name):
    ...
    sweets_brands = ["עלית", "קינדר", "אוסם", "פרינגלס", "שטראוס", "נסטלה", "כרמית", "יוניליוור", "פסק זמן", "מקופלת"]
    if any(k in name for k in sweets_brands + ["שוקולד", "במבה", "ביסלי", "עוגיות", "וופל", "סוכרייה", "צ'יפס", "חטיף", "גלידה"]):
