...
def determine_category(product_name):
    ...
    pantry_keywords = ["בטעם עוף","אורז","מרק עוף","בשמן", "גלטין","פסטה", "קוסקוס", "טונה", "שימורים", "רסק", "רוטב", "סוכר","גלטין","חתיכות","הרינג", "קמח","מחית", "שמן", "תבלין", "מלח", "קטניות", "עדשים", "שעועית", "פירורי לחם", "טחינה", "קפה", "תה"]
    ...
    # 4. טואלטיקה
    toiletries_brands = ["דאב", "פינוק", "הד אנד שולדרס", "פנטן", "ג'ילט", "לוריאל", "קולגייט"]
    if any(k in name for k in toiletries_brands + ["סבון","גילוח", "שמפו", "מרכך", "דאודורנט", "משחת שיניים"]):
        return "טואלטיקה"
