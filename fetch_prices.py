...
def determine_category(product_name):
    ...
    pantry_keywords = ["בטעם עוף","אורז", "פסטה", "קוסקוס", "טונה", "שימורים", "רסק", "רוטב", "סוכר", "קמח", "שמן", "תבלין", "מלח", "קטניות", "עדשים", "שעועית", "פירורי לחם", "טחינה", "קפה", "תה"]
    ...
    if any(k in name for k in toiletries_brands + ["סבון", "שמפו", "מרכך", "דאודורנט", "משחת שיניים"]):
        return "טואלטיקה"
